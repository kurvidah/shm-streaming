...
import { LayoutDashboard, Users, Film, CreditCard, Ticket, Settings, ChevronRight } from "lucide-react"
...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { path: "/admin/subscriptions", icon: <Ticket size={20} />, label: "Subscriptions" },
