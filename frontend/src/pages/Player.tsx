...
const Player = () => {
  ...
  useEffect(() => {
    const fetchMovieData = async () => {
      try {
        setLoading(true)
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/movies/${id}/`)
      ...
      {movieData && (
        <div className="p-4 bg-gray-900">
          ...
          <div className="flex space-x-4">
            ...
            <span className="bg-gray-800 px-2 py-1 rounded text-sm">{movieData.duration} min</span>
